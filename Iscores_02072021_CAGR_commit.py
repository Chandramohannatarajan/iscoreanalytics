...
list_dataframes_cagr= [v for k, v in root_data_cagr.groupby('NAME')]
...
conditions3_at = [
                (root_data_cagr['Istar_CAGR']==0)&(root_data_cagr['YEAR']==list_df_cagr[0][0][4]),
...
root_data_cagr[root_data_cagr['NAME']=="BASF PHARMA (CALLANISH) LIMITED"]
