# This code takes in 97000 records from 22000 companies and deliver 17 Iscores
import time
import math
import glob
start = time.time()
...
data.to_csv(r'C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/data_z.csv', index = False)
...
data_z_cagr.to_csv(r'C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/data_z_cagr.csv', index = False)
...
for k,value_year in enumerate(df_all_years):
    for l,value_type in enumerate(df_all_types):
        ...
        year_industry = year_industry[['REGISTRATION_NUMBER', 'COMPANY_NAME', 'INDUSTRY_TYPE','Year','PRETAX_PROFIT_PERCENTAGE',            
        ...
        year_industry.to_csv(r'C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/iscore/'+'iscore_'+str(value_year)+'_'+str(value_type)+r'.csv',index = False, na_rep = 'N/A')
...
import glob
os.chdir(r"C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/iscore")
extension = 'csv'
...
#export to csv
iscores_z_cagr.to_csv( "C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/iscore/iscores_z_cagr.csv", index=False)
# MERGING ISCORES FILE WITH ALL YEAR FILE
x = pd.read_csv("C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/data_z_cagr.csv",low_memory=False)
y = pd.read_csv("C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/iscore/iscores_z_cagr.csv")
z=pd.merge(x,y,how='left',on=['REGISTRATION_NUMBER', 'COMPANY_NAME', 'INDUSTRY_TYPE', 'Year'],suffixes=  
           ('','_DROP')).filter(regex='^(?!.*_DROP)')
z.drop_duplicates(keep=False,inplace=True)
z.to_csv("C://Users/44740/Machine learning/DG/Credit_Score_Analysis-master/25062021/enhanced/all_scores_25062021.csv",index=False)
...
# a simple line plot
list_dataframes[3].plot(kind='bar',x='industry_type',y='avg_iscoreall')
